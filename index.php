...
// Kategorileri sıralamak için SQL sorgusunu `category_order` alanına göre güncelliyoruz
$category_sql = "SELECT * FROM categories ORDER BY category_order ASC, category_name ASC";
    ...
    <div id="content">      
        ...
        <div id="content-container">
            ...
            <div class="scroll-button-container">
                <button class="scroll-button" onclick="scrollCategories('left')">&#9664;</button>
                ...
                <button class="scroll-button" onclick="scrollCategories('right')">&#9654;</button>
            </div>
...
<script>
    function scrollCategories(direction) {
        ...
        if (direction === 'left') {
            categoryRow.scrollBy({ left: -150, behavior: 'smooth' });
        } else {
            categoryRow.scrollBy({ left: 150, behavior: 'smooth' });
        }
    }
